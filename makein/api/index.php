...
<div class="container">
	...
	<form action="" method="get">
		<div class="form-group">
			<label for="name">http://localhost/makein/api/emp/read/(empid)</label>
			<input type="text" name="url" value="http://localhost/makein/api/emp/read/" class="form-control" required/>
