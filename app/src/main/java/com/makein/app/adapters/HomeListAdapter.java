...
import com.makein.app.controler.HomeListItems;
...
public class HomeListAdapter extends RecyclerView.Adapter<HomeListAdapter.MyViewHolder> {
    ...
    private List<MyResponse.Data> data;
    private ItemClickListener mClickListener;


    public HomeListAdapter(Context mContext, List<MyResponse.Data> data) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final HomeListAdapter.MyViewHolder holder, final int position) {

        MyResponse.Data items = data.get(position);
...
//                                        .noPlaceholder()
    ...
    public interface ItemClickListener {
        void onItemClick(View view, MyResponse.Data data);
    }
